...
- As iterações permitem feedback rápido do cliente e ajustes contínuos nos requisitos e no projeto;
- Os exemplos incluem o modelo de desenvolvimento em espiral e o modelo de desenvolvimento ágil;
- Esta característica contrasta com a abordagem clássica, na qual as fases são realizadas uma única vez;
- As principais vantagens incluem adaptação a mudanças de requisitos, maior envolvimento do cliente e entrega de valor em estágios mais curtos. No entanto, pode ser desafiador para projetos complexos gerenciar mudanças contínuas e pode exigir uma equipe altamente colaborativa e auto-organizada.

	![[Pasted image 20240318165713.png]]
