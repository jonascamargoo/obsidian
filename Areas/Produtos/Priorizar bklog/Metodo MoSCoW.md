...
**M**ust Have (mandatório) – Não mais que 60% do backlog.

**S**hould Have (Importante): Não mais que 20% do backlog

**C**ould Have (desejável): Não mais que 20% do backlog

**W**on’t Have (não fazer)
...
É conhecido como a estratégia que visa mensurar o mínimo para que o produto seja comercializado no mercado. Seguindo está estratégia você pode utilizar outras técnicas em conjunto. É uma versão um pouco mais sofisticada do MVP. Com a solução validada, começamos esse fase.

## Minimum Viable Product (MVP)

Conceitualmente, uma forma inteligente de testar o sucesso de uma ideia antes de investir recursos financeiros ou o próprio tempo nela. Parte da premissa de estabelecer o valor mínimo para que você possa colocar seu produto para experimentação e validação de hipóteses do usuário. Serve para validar a solução (deve ser iniciado apenas após validar o problema!)
