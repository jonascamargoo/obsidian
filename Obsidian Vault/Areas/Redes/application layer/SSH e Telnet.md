...
O SSH (Secure SHell) é também um protocolo que permite acessar virtualmente o servidor como se estivesse em um terminal (prompt de comandos, por exemplo). Toda a transmissão de dados no SSH é criptografada. Assim, os riscos na transmissão de senhas para acessar outros sistemas ou programas é, virtualmente, zero.

![[Pasted image 20250110172849.png]]